...
function JuniorCommittee2024() {
    ...
    return (
        ...
        <Container className="junior-2024-container">
            <h1 className="junior-2024-heading">Junior Committee 2024</h1>
